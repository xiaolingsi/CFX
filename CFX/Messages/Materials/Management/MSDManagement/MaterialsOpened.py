...
@dataclass_json
@dataclass
class MaterialsOpened(CFXMessage):
    ...
    def __init__(self, materials: List[MaterialPackageDetail] = None):
        super().__init__()
        self.type = "CFX.Materials.Management.MSDManagement.MaterialsOpened,CFX"
        self.message_name = "CFX.Materials.Management.MSDManagement.MaterialsOpened"
