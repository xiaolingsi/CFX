...
@dataclass_json
@dataclass
class MaterialsInitialized(CFXMessage):
    ...
    def __init__(self, materials: List[MaterialPackageDetail] = None):
        super().__init__()
        self.type = "CFX.Materials.Management.MaterialsInitialized,CFX"
        self.message_name = "CFX.Materials.Management.MaterialsInitialized"
