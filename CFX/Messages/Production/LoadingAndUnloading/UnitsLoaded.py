...
class UnitsLoaded(CFXMessage):
    ...
    def __init__(self, unique_identifier: str = "", units: List[UnitPosition] = None):
        super().__init__()
        self.type = "CFX.Production.LoadingAndUnloading.UnitsLoaded,CFX"
        self.message_name = "CFX.Production.LoadingAndUnloading.UnitsLoaded"
